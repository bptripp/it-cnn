...
#
#     # plt.bar(edges[:-1]+.02, null_fractions, fill=False, width=.07)
#     # plt.bar(edges[:-1]+.1, ratio_fractions, color=[1,0,0], width=.07)
#     # plt.bar(edges[:-1], ratio_fractions - null_fractions, width=.2)
...
# plt.tight_layout()
#
# print('>1 ' + str(np.mean(ratio_fractions_over_one)) + ' ' + str(np.mean(null_fractions_over_one)))
#
# if use_vgg:
